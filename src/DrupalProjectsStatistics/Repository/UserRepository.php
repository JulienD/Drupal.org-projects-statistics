...
use DrupalProjectsStatistics\Entity\User;
...
class UserRepository implements RepositoryInterface, UserProviderInterface
{
   ...
   *
   * @param \DrupalProjectsStatistics\Entity\User $user
   */
   ...
   * @param integer $id
   *
   * @return \DrupalProjectsStatistics\Entity\User|false An entity object if found, false otherwise.
   */
  ...
  {
    return 'DrupalProjectsStatistics\Entity\User' === $class;
  }
   ...
   *
   * @return \DrupalProjectsStatistics\Entity\User
   */
