...
Class ProjectDrupalCommerceRepository extends ProjectRepository
{
  /**
  ...
  public function getCount() {
    return $this->db->fetchColumn('SELECT COUNT(id) FROM projects WHERE drupal_commerce = TRUE');
  }
  ...
  public function findAll($ids = array(), $conditions = array(), $limit = 20, $offset = 0, $orderBy = array()) {
    ...
    $conditions += array('drupal_commerce' => TRUE);
